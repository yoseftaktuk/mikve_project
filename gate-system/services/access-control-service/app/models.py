...
class AccessLog(Base):
    ...
    # member_id from fingerprints-service; NULL for cash entries
    ...
    reason: Mapped[str] = mapped_column(String(60), nullable=False)  # insufficient_balance|disabled|unknown_member|...
